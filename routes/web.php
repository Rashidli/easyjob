...
Route::get('storage_link', fn () => Illuminate\Support\Facades\Artisan::call('storage:link'));

Route::get('migrate', fn () => Illuminate\Support\Facades\Artisan::call('migrate'));

Route::get('cache_reset', fn () => Illuminate\Support\Facades\Artisan::call('permission:cache-reset'));

Route::get('optimize', fn () => Illuminate\Support\Facades\Artisan::call('optimize:clear'));
