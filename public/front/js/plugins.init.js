...
try {
    var singleLocation = new Choices('#choices');
    var choices_company = new Choices('#choices_company');
...
try {
    if(document.getElementById("days")){
        ...
        var eventCountDown = new Date("October 01, 2024 16:37:52").getTime();
        ...
        var myfunc = setInterval(function () {
            ...
            document.getElementById("days").innerHTML = days + "<p class='count-head'>Gün</p> "
            document.getElementById("hours").innerHTML = hours + "<p class='count-head'>Saat</p> "
            document.getElementById("mins").innerHTML = minutes + "<p class='count-head'>Dəqiqə</p> "
            document.getElementById("secs").innerHTML = seconds + "<p class='count-head'>Saniyə</p> "
...
document.getElementById('applyButton').addEventListener('click', function () {
    ...
    // Show the tooltip and set the data-title text
    tooltip.classList.remove('hidden');
    tooltipText.textContent = this.getAttribute('data-title');
    document.getElementById('copiedMessage').classList.add('hidden');
});

document.getElementById('copyButton').addEventListener('click', function () {
    const tooltipText = document.getElementById('tooltipText').textContent;
