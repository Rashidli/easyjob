                                            ...
                                            <div class="card mb-3">
                                                ...
                                                <div class="card-body">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="{{ $lang }}_title" value="{{ $blog->translate($lang)->title }}">
                                                        @error($lang.'_title')
                                            ...
                                            <div class="card mb-3">
                                                ...
                                                <div class="card-body">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="{{ $lang }}_img_alt" value="{{ $blog->translate($lang)->img_alt }}">
                                                        @error($lang.'_img_alt')
                                                        <small class="form-text text-danger">{{ $message }}</small>
                                                        @enderror
                                                    </div>
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="{{ $lang }}_img_title" value="{{ $blog->translate($lang)->img_title }}">
                                            ...
                                            <div class="card mb-3">
                                                ...
                                                <div class="card-body">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="{{ $lang }}_meta_title" value="{{ $blog->translate($lang)->meta_title }}">
                                ...
                                <div class="card mb-3">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3 text-center">
                                            <img src="{{ asset('storage/' . $blog->image) }}" style="width: 100px; height: 100px;" class="uploaded_image" alt="{{ $blog->image }}">
                                        </div>
