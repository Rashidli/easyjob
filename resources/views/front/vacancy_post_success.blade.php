    ...
    <div class="container relative">
        <div class="grid grid-cols-1">
            <div class="title-heading text-center my-auto">
                ...
                <p class="text-slate-400 max-w-xl mx-auto">Zəhmət olmasa, vakansiyanızın saytda paylaşılması üçün aşağıdakı linkə keçid edib ödəniş üçün yazın:
                    1 Vakansiya - 10 AZN təşkil edir.</p>
{{--                <a href="https://wa.link/w4fzx6">https://wa.link/w4fzx6</a>--}}
                <a href="https://wa.me/994506761790" style="color: blue; text-decoration: underline">https://wa.me/994506761790</a>
                <div class="mt-6">
