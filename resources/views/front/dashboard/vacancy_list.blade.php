            ...
            <div class="grid md:grid-cols-12 grid-cols-1 gap-[30px]">
                ...
                <div class="lg:col-span-8 md:col-span-7">
                    <div class="p-6 rounded-md shadow-lg bg-white dark:bg-gray-800 mt-8">
                        <h5 class="text-2xl font-semibold mb-6">Vakansiyalar</h5>
                            ...
                            @foreach($vacancies as $vacancy)
                                <div class="p-4 bg-gray-50 text-black dark:text-gray-300 rounded-lg shadow-md flex justify-between items-center">
                                    <div class="flex flex-col">
                                        <a href=""><span class="text-lg font-semibold text-black dark:text-gray-300">{{ $vacancy->vacancy_name }}</span></a>
                                        <i class="uil uil-eye">{{$vacancy->views_count}}</i>
                                    </div>
                                    <div class="vacancy-status">
                                        <a href="{{ route('dynamic.page', $vacancy->slug) }}">Saytda göstər</a>
                                    </div>
                                </div>
                                <br>
                            @endforeach
